...
exports.calculateFinancialHealthScore = void 0;
const calculateFinancialHealthScore = (data) => {
    const { monthlyIncome, monthlyExpenses, budgetUsagePercentage, incomeSourceCount, recurringExpenses, } = data;
    // ------------------------------------
    ...
    const recurringExpenseRatio = recurringExpenses !== null && monthlyIncome > 0
    ...
    // 8. Normalize to 100
    // ------------------------------------
    const score = availableMaxScore > 0
    ...
    // 10. Confidence
    // ------------------------------------
    const availableFactors = 1 + // savings
        1 + // expense
        1 + // income
    ...
    return {
        ...
        breakdown: {
            ...
            metrics: {
                ...
                recurringExpensesRatio: recurringExpenseRatio !== null
